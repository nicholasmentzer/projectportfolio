        ...
        <div className="flex flex-col items-center border-t border-gray-200 pb-12 pt-8 md:flex-row md:justify-center md:pt-6">
          <div>
            ...
            <div className='flex justify-center'>
              <Button variant='outline' href="www.linkedin.com/in/nicholas-mentzer-9b4635281" className='mr-5'>LinkedIn</Button> <Button href='https://drive.google.com/file/d/1zQuc1mOKYh_g1sjmJ5nxDkZtW86l9scQ/view?usp=sharing'>My Resume</Button>
            </div>
          </div>
        </div>
      </Container>
