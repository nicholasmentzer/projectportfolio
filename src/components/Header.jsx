        ...
        <nav>
            <Container className="relative z-50 flex justify-between py-8">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <Button className='hidden lg:block' href='https://drive.google.com/file/d/1bCJZVa8sojU08opFMHhicpua13mP-BOI/view?usp=sharing'>My Resume</Button>
                                        ...
                                        <>
                                            ...
                                            <Popover.Panel static as={motion.div} initial={{opacity: 0, y: -32}} animate={{opacity: 1, y: 0}} exit={{opacity: 0, y: -32, transition: {duration: 0.2}}} className='absolute inset-x-0 top-0 origin-top rounded-b-2xl bg-gray-50 px-6 pb-6 pt-32 shadow-2xl shadow-gray-900/20'>
                                                ...
                                                <div className='mt-8 flex flex-col gap-4'>
                                                    ...
                                                    <Button href='https://drive.google.com/file/d/1bCJZVa8sojU08opFMHhicpua13mP-BOI/view?usp=sharing'>My Resume</Button>
                                                </div>
                                            </Popover.Panel>
                                        </>
                                    )}
